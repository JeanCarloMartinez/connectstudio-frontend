    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">
          Bienvenido a Connect Studio
        </h2>
        <p
          className="text-gray-600 mb-8 text-lg flex-grow
"
        >
          Conecta con compañeros para recibir y ofrecer apoyo académico.
          ¡Juntos, el aprendizaje es más fácil!
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10 items-stretch">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 h-full flex flex-col justify-between">
            <h3 className="text-xl font-semibold text-gray-800 mb-3">
              Encuentra Asesorías
            </h3>
            <p className="text-gray-600 mb-4">
              Busca compañeros que puedan ayudarte en las materias que te
              cuestan trabajo.
            </p>
            <button
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 h-full flex flex-col justify-between">
            ...
            <p className="text-gray-600 mb-4">
              Visualiza tu agenda personal y gestiona tus eventos más
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 h-full flex flex-col justify-between">
            ...
            <p className="text-gray-600 mb-4">
              Completa tu perfil para destacar, conectar y mostrar tu estilo
              único.
            </p>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
              <p className="text-gray-700 italic mb-3">
                "Gracias a Connect Studio, pude entender cálculo. ¡Mi compañero
                fue un crack explicando!"
              </p>
              <p className="text-gray-800 font-medium">- Ana G., Ingeniería</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
              <p className="text-gray-700 italic mb-3">
                "Ofrecer asesorías me ayudó a repasar y consolidar mis
                conocimientos. ¡Excelente iniciativa!"
              </p>
