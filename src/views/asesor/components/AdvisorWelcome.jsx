...
const AdvisorWelcome = ({ onNavigate }) => {
  return (
    <div className="p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center h-full text-center">
      ...
      <p className="text-lg text-gray-600 mb-8 max-w-2xl">
        Tu plataforma personalizada para gestionar cursos, asesorías y tu perfil
        profesional. Explora las opciones en el menú lateral para empezar.
      </p>
